...
$('.startbar--window-wrap').on('click', function() {
    ...
    switch (app) {
        case 'pinball--taskbar':
            if ($("#pinball--window").hasClass("is--minimized")) {
                console.log('pinball was minimized.')
                $("#pinball--window").toggleClass('is--minimized');
            } else {
                console.log('pinball was not minimized.');
                zIndex += 2;
            ...
            break;
        case 'msn--taskbar':
            if ($("#msn--window").hasClass("is--minimized")) {
        ...
        case 'notepad--taskbar':
            if ($("#notepad--window").hasClass("is--minimized")) {
            ...
            break;
        case 'winamp--taskbar':
            if ($("#winamp--window").hasClass("is--minimized")) {
        ...
        case 'bld--taskbar':
            ...
            if ($("#bld--window").hasClass("is--minimized")) {
            ...
            break;
        case 'ie--taskbar':
            if ($("#ie--window").hasClass("is--minimized")) {
        ...
        case 'portfolio--taskbar':
            if ($("#portfolio--window").hasClass("is--minimized")) {
        ...
        case 'contact--taskbar':
            if ($("#contact--window").hasClass("is--minimized")) {
        ...
        case 'clients--taskbar':
            if ($("#clients--window").hasClass("is--minimized")) {
